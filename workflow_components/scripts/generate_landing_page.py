...
def generate_landing_page(public_dir='public'):
    ...
    if (public_path / 'npm-licenses-report.html').exists():
        npm_html_report = 'npm-licenses-report.html'
    ...
    print(f"  npm HTML Report: {npm_html_report or 'N/A'}")
...
'''
    ...
    if npm_html_report:
        html += f'''
      <a href="{npm_html_report}" class="report-card highlight">
        <div class="report-icon">📦</div>
        <div class="report-title">npm License Fetch Report <span class="badge">FAST API</span></div>
        <div class="report-desc">Licenses retrieved from npm registry - reduces ScanCode workload for JavaScript packages</div>
      </a>
'''
